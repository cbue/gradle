...
class CacheLayoutTest extends Specification {
    ...
    def "use metadata store layout"() {
        ...
        cacheLayout.key == 'metadata-2.62'
        cacheLayout.version == CacheVersion.parse("2.62")
        cacheLayout.version.toString() == '2.62'
        cacheLayout.getPath(new File('some/dir')) == new File('some/dir/metadata-2.62')
